...
{
    std::cout << "[\033[32mDebug\033[0m] Entering High Score State\n";
    ...
    transformComponent->SetPosition(400.0f, 100.0f);  // Fixed: Added .0f suffix
    ...
    for (int i = 0; i < 5; ++i)
    {
        ...
        transformComponent->SetPosition(400.0f, 180.0f + static_cast<float>(i) * 40.0f);  // Fixed: Added .0f suffix and explicit cast
    ...
    transformComponent->SetPosition(350.0f, 450.0f);  // Fixed: Added .0f suffix
    ...
    public:
        ...
        {
            std::cout << "[\033[32mDebug\033[0m] Returning to main menu\n";
    ...
    std::cout << "[\033[32mDebug\033[0m] High Score State setup complete\n";
}
...
{
    std::cout << "[\033[32mDebug\033[0m] Exiting High Score State\n";
    ...
    try
    {
        ...
        std::cout << "[\033[32mDebug\033[0m] Stopped background music\n";
    }
    catch (...)
    {
