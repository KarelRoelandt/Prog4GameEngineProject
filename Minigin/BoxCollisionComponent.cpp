...
// Constructor
BoxCollisionComponent::BoxCollisionComponent(float x, float y, float width, float height, ColliderTag tag)
    : boundingBox{ x, y, width, height }, tag(tag) /*, ownerTransform(nullptr) */
{
